...
{
    // This class is taken from http://wiki.crowe.co.nz/Calculate%20Sunrise%2fSunset.ashx
    ...
    public class SunAndMoonData
    {
        ...
        public DateTime CivalTwilightStart;
        public DateTime CivalTwilightEnd;
    ...
    public class Twilight2
    {
        ...
        public string FormatDateTime(DateTime dateTime)
        {
            ...
            else if (dateTime == DateTime.MinValue.AddDays(1))
            {
                return "No Set";
            }
            ...
            else if (dateTime == DateTime.MaxValue.AddDays(-1))
            {
                return "DOWN";
            }
            else
                return dateTime.ToString("h:mmtt").Replace(".", "");
        }
    }
}
